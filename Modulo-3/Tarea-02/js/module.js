 ...
 /*export function vermas( module , container)  {
    container.innerHTML = '<div  class="caja2">'
    module.forEach((element) => {
        const {imgciudad,pais,descripcion,contiente,ciudad,id} = element
        container.innerHTML += ' <img class= "imgver" src='+imgciudad+' alt=""><div class="caja_de_texto2"><h1 class=" titulo-a ">'+pais+'</h1><div class="tecto-d">'+descripcion +'</div></div><img class="img-con"  src='+contiente+' ><form action="" class="formulario" id="form"><center><h2>agenda tu cita</h2><input type="text" name='+pais+' class="input-des" disabled><br><br><input type="text" name='+ciudad+' class="input-des" disabled><br><br>fecha de Salida<br><input class="input-des" type ="date"><br><br>fechade regreso <br><input class="input-des" type ="date"><br><br><textarea class="input-des" name="" id="3" cols="30" rows="10"></textarea><label for="comentarios"></label><button class="btn-envia">Enviar</button></center></form>'
    })
 }*/


// <a href="../tarea-02/pages/vermas.html"></a>