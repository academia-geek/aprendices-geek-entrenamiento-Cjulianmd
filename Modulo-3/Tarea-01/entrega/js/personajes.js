...
export const personajes = [
    {
         personajes: "golem",
         funcion: "javascript:Golem1()",
         imgpersonajes: "img/golem.png",
    ...
    {
       personajes: "goblin",
     funcion: "javascript:Golem6()",
      
      imgpersonajes: "img/goblin.webp",
    ...
    },
    {
     ...
     {
        personajes: "principe",
      funcion: "./pages/principe.html/#p",
       imgpersonajes: "img/principe.png",
